...
use App\Repository\doctor_dashboard\DiagonisisRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(DiagonisisRepositoryInterface::class, DiagonisisRepository::class);
        ...
        //Dashnoard_Ray_Employee
        $this->app->bind(\App\Interfaces\Dashboard_Ray_Employee\InvoicesRepositoryInterface::class,
        ...
        $this->app->bind(\App\Interfaces\Dashboard_Laboratorie_Employee\InvoicesRepositoryInterface::class,
            \App\Repository\Dashboard_Laboratorie_Employee\InvoicesRepository::class);
