...
@section('title')
    {{ trans('Dashboard\receipt_trans.receipts') }}
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('Dashboard\main-sidebar_trans.calculations') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('Dashboard\receipt_trans.receipts') }}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                ...
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('Receipt.create')}}" class="btn btn-primary" role="button"
                                           aria-pressed="true">{{ trans('Dashboard\receipt_trans.add_receipt') }}</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th>{{ trans('Dashboard\receipt_trans.patient_name') }}</th>
                                                <th>{{ trans('Dashboard\receipt_trans.amount') }}</th>
                                                <th>{{ trans('Dashboard\receipt_trans.report') }}</th>
                                                <th>{{ trans('Dashboard\receipt_trans.creation_date') }}</th>
                                                <th>{{ trans('Dashboard\receipt_trans.processes') }}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
