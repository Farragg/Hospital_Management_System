    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item"
                       href="{{ route('Sections.index') }}">{{trans('Dashboard/main-sidebar_trans.view_all')}}</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <span class="side-menu__label">{{trans('Dashboard/main-sidebar_trans.Doctors')}}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                       href="{{ route('Doctors.index') }}">{{trans('Dashboard/main-sidebar_trans.view_all')}}</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <span class="side-menu__label">{{trans('Dashboard\main-sidebar_trans.Services')}}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                ...
                <li><a class="slide-item"
                       href="{{ route('insurance.index') }}">{{trans('Dashboard\main-sidebar_trans.Insurance')}}</a>
                </li>
                <li><a class="slide-item"
                       href="{{ route('Ambulance.index') }}">{{trans('Dashboard\main-sidebar_trans.ambulance')}}</a>
                </li>
                <li><a class="slide-item"
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <span class="side-menu__label">{{ trans('Dashboard\main-sidebar_trans.pateints') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                       href="{{ route('Patients.create') }}">{{trans('Dashboard\main-sidebar_trans.add_patient')}}</a>
                </li>
                <li><a class="slide-item"
                       href="{{ route('Patients.index') }}">{{trans('Dashboard\main-sidebar_trans.patients_list')}}</a>
                </li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <span class="side-menu__label">{{ trans('Dashboard\main-sidebar_trans.invoices') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                       href="{{ route('single_invoices')}}">{{trans('Dashboard\main-sidebar_trans.invoice')}}</a></li>
                <li><a class="slide-item"
                       href="{{ route('group_invoices')}}">{{trans('Dashboard\main-sidebar_trans.group_invoice')}}</a>
                </li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <span class="side-menu__label">{{trans('Dashboard\main-sidebar_trans.calculations')}}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                       href="{{ route('Receipt.index') }}">{{trans('Dashboard\main-sidebar_trans.receipt')}}</a></li>
                <li><a class="slide-item"
                       href="{{ route('Payment.index') }}">{{trans('Dashboard\main-sidebar_trans.payment')}}</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <span class="side-menu__label">{{trans('Dashboard\main-sidebar_trans.rays')}}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                       href="{{ route('ray_employee.index') }}">{{trans('Dashboard\main-sidebar_trans.employees_list')}}</a>
                </li>
                <li><a class="slide-item"
                       href="{{ route('ray_employee.store') }}">{{trans('Dashboard\main-sidebar_trans.examinations_list')}}</a>
                </li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <span class="side-menu__label">{{trans('Dashboard\main-sidebar_trans.laboratorie')}}</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('laboratorie_employee.index')}}">{{trans('Dashboard\main-sidebar_trans.employees_list')}}</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                ...
                <span class="side-menu__label">{{trans('Doctors.appointments')}}</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('appointments.index') }}">{{trans('Doctors.appointments_list')}}</a></li>
                <li><a class="slide-item" href="{{ route('appointments.index2')}}">{{trans('Doctors.verified_appointments')}}</a></li>
                <li><a class="slide-item" href="{{ url('/' . $page='map-vector') }}">{{trans('Doctors.completed_appointments')}}</a></li>
            </ul>
        </li>
