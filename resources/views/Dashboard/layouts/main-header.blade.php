            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>{{trans('Dashboard\login_trans.profile')}}</a>
                        <a class="dropdown-item" href=""><i class="bx bx-cog"></i>{{trans('Dashboard\login_trans.edit_profile')}}</a>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @elseif(auth('admin')->check())
                                    <form method="POST" action="{{ route('logout.admin') }}">
                                        ...
                                        this.closest('form').submit();"><i class="bx bx-log-out"></i>{{trans('Dashboard\login_trans.logout')}}</a>
                                                    </form>
