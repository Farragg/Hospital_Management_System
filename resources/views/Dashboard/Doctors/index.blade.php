                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                          ...
                          @foreach($doctors as $doctor)
                              <tr>
                                  ...
                                  <td>
                                      <input name="delete_select" class="delete_select" type="checkbox" value="{{ $doctor->id }}" >
                                  </td>
                                  <td>{{ $doctor->name }}</td>
                                  <td>
                                      @if($doctor->image)
                                  ...
                                  <td>
                                      <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu tx-13">
                                              <a class="dropdown-item" href="{{route('Doctors.edit',$doctor->id)}}"><i style="color: #0ba360" class="text-success ti-user"></i>&nbsp;&nbsp;{{trans('doctors.edit_info')}}</a>
                                              ...
                                              <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete{{$doctor->id}}"><i   class="text-danger  ti-trash"></i>&nbsp;&nbsp;{{trans('doctors.delete_info')}}</a>
