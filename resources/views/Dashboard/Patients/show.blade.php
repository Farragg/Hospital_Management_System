...
@endsection
@section('title')
    {{ trans('Dashboard/main-sidebar_trans.patients_info')}}
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('Dashboard/main-sidebar_trans.patients_info')}}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('Dashboard/main-sidebar_trans.patients_info')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                    ...
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li class="nav-item"><a href="#tab1" class="nav-link active"
                                                                    data-toggle="tab">{{ trans('Dashboard\main-sidebar_trans.patients_info')}}</a></li>
                                            <li class="nav-item"><a href="#tab2" class="nav-link" data-toggle="tab">{{ trans('Dashboard\main-sidebar_trans.patients_info')}}</a>
                                            </li>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>{{ trans('Dashboard\patient.patient_mail')}}</th>
                                                        <th>{{ trans('Dashboard\patient.patient_birthdate')}}</th>
                                                        <th>{{ trans('Dashboard\patient.patient_gender')}}</th>
                                                        <th>{{ trans('Dashboard\patient.patient_blood_group')}}</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr>
